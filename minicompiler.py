# ============================================
# ENHANCED MINI COMPILER PROJECT
...
class Parser:
    ...
    def parse_declaration(self):
        """Parse variable declaration: int x = 5; float y = 3.14; string s = "hello";"""
    ...
    def parse_factor(self):
        """Parse factor (number/float/string or variable or parenthesized expression)"""
        token = self.current_token()
...
class Compiler:
    ...
    def compile(self):
        ...
        print("\n" + "="*60)
        print(" ENHANCED MINI COMPILER - CSE 430 Project")
        print(" With String and Float Support")
        print("="*60)
        ...
        try:
            ...
            asm_generator = AssemblyGenerator(tac, symbol_table, ic_generator.string_literals)
...
# ============================================
# TEST PROGRAM WITH STRING AND FLOAT
# ============================================
...
if __name__ == "__main__":
    ...
    int y = 20;
    float sum = x + y;
    string s = "Sheikh Muhammad Ashik";
    print(sum  - 1);
